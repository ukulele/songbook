...
\ifpdf%
  \usepackage[pdftex]{graphicx}% to include graphics
    ...
    \usepackage[pdftex,     % sets up hyperref to use pdftex driver
            ...
            pdfproducer={Latex},
            pdfauthor={Vish Vishvanath and Charlie Ullman and Alyn Gwyndaf and Matt Gunning}
            colorlinks=true
            dfstartview=FitV
            linkcolor=blue
            citecolor=blue
...
\newcommand{\AsusFour}{\marginpar{\chord{t}{2,2,o,o}{Asus4}}}
...
\newcommand{\CsusFour}{\marginpar{\chord{t}{o,o,1,3}{Csus4}}}
...
\newcommand{\DminorA}{\marginpar{\chord{t}{2,o,2,o}{D\large{m}A}}}
...
\newcommand{\FsusFour}{\marginpar{\chord{t}{3,o,1,o}{F\large{sus4}}}}
...
\newcommand{\GsevenSusFour}{\marginpar{\chord{t}{o,2,1,3}{G7sus4}}}
\newcommand{\GsusFour}{\marginpar{\chord{t}{o,2,3,3}{G7sus4}}}
...
\include{songs/a/africa}
\include{songs/a/america}
\include{songs/a/americangirl}
\include{songs/a/allmylittlewords}
\include{songs/a/allthesmallthings}
\include{songs/b/barenecessities}
\include{songs/b/bennyandthejets}
\include{songs/b/boysofsummer}
\include{songs/b/breathless}
\include{songs/c/cakebytheocean}
\include{songs/c/callmemaybe}
\include{songs/c/cantcatchmenow}
\include{songs/c/carolbrown}
%\include{songs/c/cantstopthefeeling}
\include{songs/c/countryroads}
\include{songs/c/crocodilerock}
\include{songs/c/crueltobekind}
\include{songs/d/damnthesevampires}
\include{songs/d/dancinginthedark}
\include{songs/d/dancingqueen}
\include{songs/d/daydreambeliever}
\include{songs/d/debaser}
\include{songs/d/delilah}
\include{songs/d/dontstopbelieving}
\include{songs/d/dontlookbackinanger}
...
\include{songs/d/doyouloveme}
%\include{songs/e/echo_beach}
\include{songs/e/exsandohs}
\include{songs/e/everybodywantstobeacat}
\include{songs/f/fidelity}
\include{songs/f/firework}
\include{songs/f/fireflies}
\include{songs/f/fiveyearstime}
\include{songs/f/five_foot_two}
\include{songs/f/fouxdufafa}
\include{songs/g/thegambler}
\include{songs/g/goldenbrown}
\include{songs/h/hallelujah}
\include{songs/h/headoverfeet}
\include{songs/h/herecomesthehotstepper}
\include{songs/h/hohey}
\include{songs/h/hotelcalifornia}
\include{songs/h/hotelyorba}
\include{songs/h/houndsoflove}
\include{songs/k/kingoftheroad}
\include{songs/i/islandinthesun}
\include{songs/i/imnotgoingtoteachyourboyfriendhowtodance}
\include{songs/i/istillhaventfoundwhatimlookingfor}
\include{songs/i/istanbulnotconstantinople}
%\include{songs/i/iwillsurvive}
\include{songs/j/justlikeheaven}
\include{songs/l/lastnite}
\include{songs/l/letsdoit}
\include{songs/l/letitbe}
\include{songs/l/livinonaprayer}
\include{songs/m/mammamia}
\include{songs/m/meandjulio}
\include{songs/m/mistersandman}
\include{songs/m/themanwhosoldtheworld}
...
% START SONGS NZ
\include{songs/n/nellietheelephant}
\include{songs/p/partyintheusa}
\include{songs/p/payphone}
\include{songs/p/pianoman}
%\include{songs/r/radiogaga}
\include{songs/r/roar}
\include{songs/r/romeoandjuliet}
\include{songs/r/rollinginthedeep}
\include{songs/s/satelliteoflove}
\include{songs/s/shoop_shoop_song}
\include{songs/s/sloopjohnb}
\include{songs/s/shiny}
\include{songs/s/shotgun}
\include{songs/s/shout}
\include{songs/s/shutupanddancewithme}
\include{songs/s/singleladies}
\include{songs/s/sitdown}
\include{songs/s/solsburyhill}
\include{songs/s/songtothesiren}
\include{songs/s/soundofthesuburbs}
\include{songs/s/straighttoyou}
\include{songs/s/sweethomealabama}
\include{songs/s/sunaintgonnashineanymore}
\include{songs/t/teenagedirtbag}
\include{songs/t/thatsnotmyname}
\include{songs/t/theonlylivingboyinnewyork}
\include{songs/t/thismustbetheplace}
\include{songs/t/tinydancer}
\include{songs/t/totaleclipseoftheheart}
\include{songs/t/twistandshout}

%\include{songs/t/times_they_are_a_changin}
%\include{songs/w/williamharker}
\include{songs/w/wakawaka}
\include{songs/w/weareneverevergettingbacktogether}
\include{songs/w/webuiltthiscity}

\include{songs/w/whatsup}
\include{songs/w/whenimgone}
\include{songs/w/whenwillmylifebegin}
\include{songs/w/whereismymind}
\include{songs/w/wherethestreetshavenoname}
\include{songs/w/witchdoctor}
\include{songs/w/withorwithoutyou}
\include{songs/y/yourewelcome}
